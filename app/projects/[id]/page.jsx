      ...
      return (
        <div className={styles.main}>
          ...
          <div className={styles.icon}>
            <a
              href="https://assignment1-silk.vercel.app"
              alt="link to vercel live"
              target="_blank"
              rel="noreferrer"
            >
    ...
    case 'project2':
      return (
        <div className={styles.main}>
          ...
          <div className={styles.icon}>
            <a href="/projects" alt="link to vercel live" target="_blank">
              <HiOutlineStatusOnline />
            </a>
            <a
    ...
    case 'project3':
      return (
        <div className={styles.main}>
          ...
          <div className={styles.icon}>
            <a
              href="https://random-numbergenerator.vercel.app"
              alt="link to vercel live"
              target="_blank"
              rel="noreferrer"
            >
    ...
    case 'project4':
      return (
        <div className={styles.main}>
          ...
          <div className={styles.icon}>
            <a
              href="https://assignment4-nishasaraswat07.vercel.app"
              alt="link to vercel live"
              target="_blank"
              rel="noreferrer"
            >
    ...
    case 'project5':
      return (
        <div className={styles.main}>
          ...
          <div className={styles.icon}>
            <a
              href="https://my-portfolio-nishasaraswat07.vercel.app"
              alt="link to vercel live"
              target="_blank"
              rel="noreferrer"
            >
